...
const ShimmerSkeleton = () => {
  return (
    <Fragment>
      <section className="m-4 md:mx-8 md:my-12 mt-32 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {Array(8)
          .fill("")
          .map((_, index) => (
            <div
              key={index}
              className="relative col-span-1 m-2 animate-pulse bg-gray-200 rounded-md"
            >
